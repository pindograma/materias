...
with open('cities.csv') as f:
    ...
    for line in reader:
        ...
        try:
            data = requests.get('https://resultados.tse.jus.br/oficial/ele2020/divulgacao/oficial/426/dados-simplificados/{}/{}{}-c0013-e000426-r.json'.format(
    ...
    keys = oup[0].keys()
    with open('resultados.csv', 'w', newline='') as output_file:
